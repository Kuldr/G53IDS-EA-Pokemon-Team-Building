...
\begin{itemize}
	...
	\item Happiness
	\item Nature
	\item EVs (Seperate values for Hit Points, Attack, Defense, Special Attack, Special Defense, Speed)
	\item IVs (Seperate values for Hit Points, Attack, Defense, Special Attack, Special Defense, Speed)
