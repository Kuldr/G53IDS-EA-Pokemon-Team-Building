...
\begin{equation}
{805 \choose 6} \approx 3.7 \times 10^{14} %370,964,071,354,800 to be exact
\end{equation}
\par
...
\end{equation}
\begin{equation}
    {805 \times 31^6 \times 256^6 \times 100 \times 256 \times 3 \times 2 \times 354 \times {728 \choose 4} \choose 6} \approx 5.806 \times 10^{261}
\end{equation} %  exactly :P
\par
...
The benchmark function is the Sum of Squares, in this the objective value is the sum of the squares of all the elements (2 in this example).
...
\begin{equation}
    range = (-5, 5), generations = 50, populationSize = 10, mutationRate = 0.1
\end{equation}
Running it 5 times gave the following results:
\begin{center}
    \begin{tabular}{ c c | c }
        x & y & Objective Value \\
        \hline
